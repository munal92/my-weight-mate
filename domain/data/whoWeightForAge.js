 ...
 *
 * Source: WHO Child Growth Standards, weight-for-age, birth to 60 months.
 * https://www.who.int/tools/child-growth-standards/standards/weight-for-age
 *
 * These are medical reference values. Never estimate, interpolate by hand, or
 * "clean up" a row — a wrong parameter here puts a wrong percentile in front of
 * a parent. Replace the whole table from the official source or not at all.
 *
 * The published tables also carry SD3neg..SD3 weight columns derived from these
 * same L/M/S values, which makes the table self-checking: recomputing those
 * weights from L/M/S agrees with the published columns to within 0.05 kg, the
 * rounding of the published values. `scripts/check-domain.mjs` asserts this,
 * so a corrupted or invented row fails the check rather than shipping quietly.
 *
